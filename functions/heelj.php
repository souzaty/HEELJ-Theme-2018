...
register_sidebar(array(
	...
	'description' => 'Aparece nas páginas com modelo "Página de Notícias".',
...
register_sidebar(array(
	...
	'id' => 'sidebar-contato',
	'description' => 'Aparece nas páginas com modelo "Página de Contato".',
	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
	'after_widget' => '</aside>',
	'before_title' => '<h4 class="widget-title">',
	'after_title' => '</h4>'
...
register_sidebar(array(
	...
	'id' => 'sala-impresa',
	'description' => 'Aparece nas páginas com modelo "Página Sala de Imprensa".',
	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
	'after_widget' => '</aside>',
	'before_title' => '<h4 class="widget-title">',
	'after_title' => '</h4>'
...
register_sidebar(array(
	...
	'description' => 'Aparece no rodapé do tema na coluna 1',
...
register_sidebar(array(
	...
	'description' => 'Aparece no rodapé do tema na coluna 2',
	'before_widget' => '<aside id="%1$s" class="widget %2$s footer-menu">',
	'after_widget' => '</aside>',
	'before_title' => '<h4 class="widget-title">',
	'after_title' => '</h4>'
...
register_sidebar(array(
	...
	'description' => 'Aparece no rodapé do tema na coluna 3',
	'before_widget' => '<aside id="%1$s" class="widget %2$s footer-menu">',
	'after_widget' => '</aside>',
	'before_title' => '<h4 class="widget-title">',
	'after_title' => '</h4>'
...
register_sidebar(array(
	...
	'description' => 'Aparece no rodapé do tema na coluna 4',
	'before_widget' => '<aside id="%1$s" class="widget %2$s footer-menu">',
	'after_widget' => '</aside>',
	'before_title' => '<h4 class="widget-title">',
	'after_title' => '</h4>'
